...
Aplikacja wykorzystuje zewnętrzne API: https://carbon-intensity.github.io/api-definitions/?shell#get-generation-from-to
...
* **Kalkulator EV:** Algorytm "Sliding Window" wyszukujący najlepsze okno czasowe (1-6h) na ładowanie samochodu, bazując na najwyższym udziale zielonych źródeł energii.
* **Inteligentna Legenda:** Dynamicznie generowana legenda, która adaptuje się do dostępnych źródeł energii.
* **IN Memory Cache:** API nie jest odpytywane jeżeli nie spowodowało by to zmiany w danych. Dane są przechowywane w pamięci operacyjnej serwera.
...
Projekt składa się z dwóch niezależnych części: serwera i klienta. Wymagają uruchomienia w osobnych terminalach. Projekt zawiera również przygotowane Dockerfile po jednym dla frontendu i backendu.
...
### !(Nie ma potrzeby ustawiać zmiennych środowiskowych przy uruchomieniu w terminalach (lokalnie) ze względu na wartości domyślne przygotowane w kodzie)!
